...
Label: 日記,OSS Gate
Permalink: impression-oss-gate
Write from next line:

昨年末あたりから"OSS Gate"というキーワードをちらほらと見かけており、どういったものなのか検索したら<a href="http://sho.tdiary.net/20151215.html">立ち上げの背景の話</a>を見つけまして、非常に興味を持っておりました。
...
しかも苦い経験がひとつあって、<a href="http://abcde.einval.com/wiki/FrontPage">abcde(A Better CD Encoder)</a>というリッピングソフトをずっと使っていまして、2年くらい前にabcdeでqaacエンコーダが使いたいなと思ってスクリプトを弄ったりして、<a href="http://knockcrab.blogspot.jp/2013/11/debianqaac-2.html">その記録をブログに残したりもしていた</a>のですが、「これ、せっかく動いているんだからパッチを送ったほうがいいのでは？」と迷いました。でもqaacは動作にWineとApple Application Supportに含まれているライブラリが必須で、なんとなくグレーな気がして、その時はブログに書くだけに留めました。
しかし、最近調べたら<a href="https://code.google.com/archive/p/abcde/issues/142">issueが立てられて</a>2.7.1でqaacが正式に対応されており、「もし自分がパッチを送っていたら、2年前にはとっくに対応してくれてたかもしれないんだよな...」なんて思っちゃって、今となってはどうして勇気が出せなかったのかなあと後悔しています。
...
大体の流れとしては、それぞれの参加者が対象にしているOSSをまず動かし、その時の作業ログをgithubのissueに書き、ログを見ながらフィードバックをする、ということをしました。時々進行の方がスライドをまじえて押さえるべきポイントを説明しているのを聞きつつ、各々作業していました。実際の作業ログについては、今もちゃんと残っているので<a href="https://github.com/oss-gate/workshop/issues/9">興味があったらどうぞ。</a>
...
<a href="https://oss-gate.doorkeeper.jp">OSS Gate | Doorkeeper</a>
